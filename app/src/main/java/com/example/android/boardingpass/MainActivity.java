...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long totalMinUntilBoarding = info.getMinutesUntilBoarding();
        long hrsUntilBoarding = TimeUnit.MINUTES.toHours(totalMinUntilBoarding);
        long minLessHrsUntilBoarding = totalMinUntilBoarding - TimeUnit.HOURS.toMinutes(hrsUntilBoarding);
        // TODO (8) Use TimeUnit methods to format the total minutes until boarding
        String hoursAndMinutesUntilBoarding =String.format("%1$s2 : %2$s2", hrsUntilBoarding, minLessHrsUntilBoarding);
