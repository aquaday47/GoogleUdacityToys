...
public class ReminderUtilities {
    ...
    public static final String UTIL_TAG = ReminderUtilities.class.getSimpleName();
    private static final int REMINDER_INTERVAL_SECONDS = (int) TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_MINUTES);
    public static final int SYNC_FLEXTIME_SECONDS = REMINDER_INTERVAL_SECONDS;
    public static final String REMIND_JOB_TAG = "charging_reminder";
    ...
    synchronized public static  void scheduleChargingReminder(@NonNull final Context context){
        ...
        Log.d(UTIL_TAG, "entering scheduleReminder");
        if (sInitialized) {
            return;
        }
        ...
        Log.d(UTIL_TAG, "entering JobBuilder");
        Job remindChargingTask = dispatcher.newJobBuilder()
        ...
        dispatcher.schedule(remindChargingTask);
       Log.d(UTIL_TAG, "reminder task scheduled");
