...
public class ReminderTasks {
    public static final String TAG = ReminderTasks.class.getSimpleName();
    public static final String ACTION_INCREMENT_WATER_COUNT = "increment-water-count";
    public static final String ACTION_DISMISS_NOTIFICATION = "dismiss-notification";
    public static final String  ACTION_CHARGING_NOTIFICS = "charging-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_CHARGING_NOTIFICS.equals(action)){
            notifyOnCharge(context);
        }
    }
    ...
    // TODO //DONE// (2) Create an additional task for issuing a charging reminder notification.
    ...
    private static void notifyOnCharge(Context context){
        Log.d(TAG, "has diverted action to notifyOnCharge");
