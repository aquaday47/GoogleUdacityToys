...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mReceiver = new ChargingBroadcastReceiver();
...
// TODO (7) Override onResume and setup your broadcast receiver. Do this by calling
    ...
    public void showCharging(boolean showPink){
        if (showPink) mChargingImageView.setImageResource(R.drawable.ic_power_pink_80px);
        else mChargingImageView.setImageResource(R.drawable.ic_power_grey_80px);
    }
    /**
