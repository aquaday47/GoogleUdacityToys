...
public class NotificationUtils {
    ...
    /**
     * pending intent id for cancelling notific
     */
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 924;
    private static final int ACTION_DRINK_FROM_NOTIFIC_PENDING_INTENT_ID = 830;
    ...
    //  TODO //DONE// (1)  Create a method to clear all notifications
    public static void clearAllNotifications(Context context){
        NotificationManager notificsMngr = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
        notificsMngr.cancelAll();
    }
     ...
     * drinkWaterAction
     * @param context
     * @return Action for incrementingCounter, passed to addAction() in our notificationManager setup
     */
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent drinkFromNotificsPendingIntent = PendingIntent.getService(context,
                ACTION_DRINK_FROM_NOTIFIC_PENDING_INTENT_ID,
                drinkIntent,
                PendingIntent.FLAG_CANCEL_CURRENT);
        //      TODO (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkAction = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                "I did it", drinkFromNotificsPendingIntent);
