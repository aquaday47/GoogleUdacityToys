...
public class NotificationUtils {
    private static final int WATER_REMINDER_NOTIFICATION_ID = 10293;
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 47;
    private static final String WATER_REM_NOTIF_CHANNEL_ID = "h20_reminder_notifics_channel";
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel mChannel = new NotificationChannel(WATER_REM_NOTIF_CHANNEL_ID,
                    context.getString(R.string.notifics_channel_name),
                    NotificationManager.IMPORTANCE_HIGH);
            nm.createNotificationChannel(mChannel);
        }

        // TODO (10) In the remindUser method use NotificationCompat.Builder to create a notification
        NotificationCompat.Builder notificsBuilder =
                new NotificationCompat.Builder(context, WATER_REM_NOTIF_CHANNEL_ID)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN
            ...
            notificsBuilder.setPriority(NotificationCompat.PRIORITY_HIGH);
        }
        // TODO (12) Trigger the notification by calling notify on the NotificationManager.
        // Pass in a unique ID of your choosing for the notification and notificationBuilder.build()
        nm.notify(WATER_REMINDER_NOTIFICATION_ID, notificsBuilder.build());
    }
