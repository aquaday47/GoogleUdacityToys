...
implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER  = 23047;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //?? Doesn't look like this signature matches the suggestion
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery==null || githubQuery.equals("")){
            mErrorMessageDisplay.setText(R.string.error_blank);
            return;
        }
        ...
        Loader<String> githubSearchLoader = lm.getLoader(GITHUB_SEARCH_LOADER);
